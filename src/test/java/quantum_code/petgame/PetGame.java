...
public class PetGame
{
    ...
    // Especie - Dog - Cat
    public String[]pet_ep = {"Dog", "Cat"};
    public int escolha_esp = 0;
    ...
    public PetGame() {
        ...
        System.out.println("Qual é a especie do Pet (0 - Dog | 1 - Cat)?");
        escolha_esp = sc.nextInt();
       if (escolha_esp == 0){
           System.out.println("Dog");
       }
       else if (escolha_esp == 1){
           System.out.println("Cat");
       }
       else {
           escolha_esp = 0;
           System.out.println("No momento não temos especie suficiente - por padrão 0 - Dog");
       }
       System.out.println("==================================================================");
       sc.nextLine();
    ...
    public void imprimir() {
        System.out.println("\n=============================================================");
        System.out.println("Especie: " + pet_ep[escolha_esp]);
    ...
    public void menu() {
        System.out.println("\nMenu");
        System.out.println("0 - Trocar de Pet;");
